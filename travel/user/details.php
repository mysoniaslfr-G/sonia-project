...
<body>
    ...
    <div class="back">
        <a href="ind.php#categories" class="btn-back"><i class="ri-arrow-left-line"></i></a>
    </div>

    <section class="gallery-details">
        <div class="flex-gallery">
            <div class="image" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                <img src="../admin/gallery/<?php echo $g->gallery_image ?>" width="100%">
            </div>
            <div class="content" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">
                <h3><?php echo $g->gallery_name ?></h3>
                <p><?php echo $g->gallery_desc ?></p>
            </div>
        </div>

        <div class="flex-gallery">
            <div class="content" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="500">
                <h3>Description</h3>
                <p><?php echo $g->description ?></p>
                <h4><a href="https://wa.me/6281234567890?text=Hello%2C%20I%20would%20like%20to%20inquire%20about%20rental%20options%20for%20Tanah%20Lot" >Contact Now </a></h4>
            </div>
            <div class="image" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="500">
                <iframe src="<?php echo $g->map_embed; ?>" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen rel="noopener noreferrer"></iframe>
            </div>
        </div>
    </section>   
